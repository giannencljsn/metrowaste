...
echo '</script>';
				...
				<!-- Attendance -->
						<li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="mdi mdi-clipboard-text"></i><span class="hide-menu" data-toggle="tooltip" title="Attendance Management">Attendance</span></a>
							<ul aria-expanded="false" class="collapse"> 
							<li><a href="<?php echo base_url(); ?>employee/getFingerprintList">Fingerprint Registered list</a></li>
				...
				<!-- Payroll -->
						<li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="mdi mdi-receipt"></i><span class="hide-menu" data-toggle="tooltip" title="Payroll Management">Payroll</span></a>
							<ul aria-expanded="false" class="collapse">
				...
				<!-- Leave -->
						<li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="mdi mdi-account-off"></i><span class="hide-menu" data-toggle="tooltip" title="Leave Management">Leave </span></a>
                            <ul aria-expanded="false" class="collapse">
						 ...
						 <!---Organization--->
						 <!---update 11/05/23--->
                        <li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="fa fa-building-o"></i><span class="hide-menu" data-toggle="tooltip" title="Organization Management">Organization </span></a>
                            <ul aria-expanded="false" class="collapse">
				...
				<!-- Notice -->
						<li> <a href="<?php echo base_url()?>notice/All_notice" ><i class="mdi mdi-clipboard"></i><span class="hide-menu" data-toggle="tooltip" title="Notice Management">Notice <span class="hide-menu"></a></li>
						<?php } ?>
					</ul>
                </nav>
