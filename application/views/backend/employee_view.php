                                ...
                                <a class="btn btn-circle btn-secondary" href="<?php if(!empty($socialmedia->google_Plus)) echo $socialmedia->google_Plus ?>" target="_blank"><i class="fa fa-google"></i></a>
				                                ...
				                                <form class="row" action="Update" method="post" enctype="multipart/form-data">
                                                   ...
                                                   <?php if($this->session->userdata('user_type')=='EMPLOYEE'){ ?>  <?php } else { ?> 
                                                    ...
                                                    <div class="form-group col-md-4 m-t-10">
                                                        <label>Status </label>
                                                        <select name="status" <?php if($this->session->userdata('user_type')=='EMPLOYEE'){ ?> readonly <?php } ?> class="form-control custom-select" >
                                            ...
                                            <?php endforeach; ?>
				                                    ...
				                                    <div class="form-group col-md-4 m-t-10">
				                                        <labe>Username </label>
				                                        <input type="text" id="example-email2" name="email" class="form-control" <?php if($this->session->userdata('user_type')=='EMPLOYEE'){ ?> readonly <?php } ?> value="<?php echo $basic->em_email; ?>" placeholder="username" minlength="7" > 
				                                    </div>
                                           ...
                                           <div class="row">
											...
											<div class="form-group col-md-6 m-t-5">
												...
												<label>Rest Day Duty</label>
			                                        <input type="text" name="restduty" <?php if($this->session->userdata('user_type')=='EMPLOYEE'){ ?> readonly <?php } ?> class="form-control form-control-line restduty" placeholder="Rest Duty" value="<?php if(!empty($salaryvalue->basic)) echo $salaryvalue->basic ?>" > 
			                                    </div> 
												<!-- Rest Day  Duty-->
												<!-- Straight Duty -->
			                                    <div class="form-group col-md-6 m-t-5">
			                                        <label>Straight Duty</label>
			                                        <input type="text" name="straightduty" <?php if($this->session->userdata('user_type')=='EMPLOYEE'){ ?> readonly <?php } ?> class="form-control form-control-line straightduty" placeholder="Straight Duty" value="<?php if(!empty($salaryvalue->house_rent)) echo $salaryvalue->house_rent ?>" > 
			                                    </div> 
												<!-- Straight Duty -->
												<!-- Special Holiday -->
			                                    <div class="form-group col-md-6 m-t-5">
			                                        <label>Special Holiday</label>
			                                        <input type="text" name="specialholiday" <?php if($this->session->userdata('user_type')=='EMPLOYEE'){ ?> readonly <?php } ?> class="form-control form-control-line specialholiday" placeholder="Special Holiday" value="<?php if(!empty($salaryvalue->medical)) echo $salaryvalue->medical ?>" > 
			                                    </div> 
												<!-- Special Holiday -->
												<!-- Legal Holiday -->
			                                    <div class="form-group col-md-6 m-t-5">
			                                        <label>Legal Holiday</label>
			                                        <input type="text" name="legalholiday" <?php if($this->session->userdata('user_type')=='EMPLOYEE'){ ?> readonly <?php } ?> class="form-control form-control-line legalholiday" placeholder="Legal Holiday" value="<?php if(!empty($salaryvalue->conveyance)) echo $salaryvalue->conveyance ?>" > 
			                                    </div>
												<!-- Legal Holiday -->
												 <!-- Solid divider -->
												 <hr class="solid">
												 ...
												 <label>Absences</label>
			                                        <input type="text" name="absences" <?php if($this->session->userdata('user_type')=='EMPLOYEE'){ ?> readonly <?php } ?> class="form-control form-control-line absences" placeholder="Absences" value="<?php if(!empty($salaryvalue->total)) echo $salaryvalue->total ?>" minlength="3" required> 
												 </div>
												 <div class="form-group col-md-6 m-t-5">
												   </div>
													<!-- Total Salary -->
												...
												<label><b>SSS Loans:</b></label><br>
			                                        <label>SSS</label>
			                                        <input type="text" name="sss" <?php if($this->session->userdata('user_type')=='EMPLOYEE'){ ?> readonly <?php } ?> class="form-control form-control-line sss" placeholder="SSS" value="<?php if(!empty($salaryvalue->bima)) echo $salaryvalue->bima ?>"> 
													<br>
													<label>SSS Provident Fund</label>
			                                        <input type="text" name="sssprovident" <?php if($this->session->userdata('user_type')=='EMPLOYEE'){ ?> readonly <?php } ?> class="form-control form-control-line sssprovident" placeholder="SSS Provident Fund" value="<?php if(!empty($salaryvalue->bima)) echo $salaryvalue->bima ?>"> 
												</div>
			                                
			                                    <div class="form-group col-md-6 m-t-5">
			                                        <label>Philhealth</label>
			                                        <input type="text" name="philhealth" <?php if($this->session->userdata('user_type')=='EMPLOYEE'){ ?> readonly <?php } ?> class="form-control form-control-line philhealth" placeholder="Philhealth" value="<?php if(!empty($salaryvalue->provident_fund)) echo $salaryvalue->provident_fund ?>"><br>
														
														<label>HDMF</label>
														<input type="text" name="hdmf" <?php if($this->session->userdata('user_type')=='EMPLOYEE'){ ?> readonly <?php } ?> class="form-control form-control-line hdmf" placeholder="HDMF" value="<?php if(!empty($salaryvalue->provident_fund)) echo $salaryvalue->provident_fund ?>"> <br>
														<label>Withholding Tax</label>
			                                        	<input type="text" name="whtax" <?php if($this->session->userdata('user_type')=='EMPLOYEE'){ ?> readonly <?php } ?> class="form-control form-control-line whtax" placeholder="Withholding Tax" value="<?php if(!empty($salaryvalue->provident_fund)) echo $salaryvalue->provident_fund ?>"> <br>
												</div>
												
												
												<div class="form-group col-md-6 m-t-5">
			                                        <label>Cash Advances</label>
			                                        <input type="text" name="cashadvances" <?php if($this->session->userdata('user_type')=='EMPLOYEE'){ ?> readonly <?php } ?> class="form-control form-control-line cashadvances" placeholder="Cash Advances" value="<?php if(!empty($salaryvalue->provident_fund)) echo $salaryvalue->provident_fund ?>"> 
			                                    </div>
												<div class="form-group col-md-6 m-t-5">
